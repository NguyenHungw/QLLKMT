<?php  
    ...
    for($i=1;$i<=$totalPage;$i++){
        if($page==$i){
            $list_page.='<li class="active"><a href="/index4.php?page_layout=danhsachsp&id_dm='.$id_dm.'&page='.$i.'" >'.$i.'</a></li>';
        }else{
            $list_page.='<li><a href="/index4.php?page_layout=danhsachsp&id_dm='.$id_dm.'&page='.$i.'">'.$i.'</a></li>';
        }
    }
?>
...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            <a href="/index4.php?page_layout=chitietsp&id_sp=<?php echo $row['id_sp']; ?>"><img width="120" height="144" src="quantri/anh/<?php echo $row['anh_sp']; ?>"></a>
