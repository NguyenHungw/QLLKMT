   ...
   <!-- <h2 class="h2-bar">sản phẩm đặc biệt</h2> -->
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            <a href="index4.php?page_layout=chitietsp&id_sp=<?php echo $row['id_sp']; ?>"><img width="80" height="144" src="quantri/anh/<?php echo $row['anh_sp']; ?>"></a>
            <h3><a href="index4.php?page_layout=chitietsp&id_sp=<?php echo $row['id_sp']; ?>"><?php echo $row['ten_sp']; ?></a></h3>
...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            ...
            <a href="index4.php?page_layout=chitietsp&id_sp=<?php echo $row2['id_sp']; ?>"><img width="140" height="144" src="quantri/anh/<?php echo $row2['anh_sp']; ?>"></a>
            <h3><a href="index4.php?page_layout=chitietsp&id_sp=<?php echo $row2['id_sp']; ?>"><?php echo $row2['ten_sp']; ?></a></h3>
