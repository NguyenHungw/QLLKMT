            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <h3>Ram DDR4 Corsair Vengeance LPX 8G/3600 Black Heat Spreader (CMK8GX4M1D3600C18)</h3>
                        ...
                        <div class="product__details__price">690,000₫</div>
                        <br>
                                ...
                                <div class="product__details__tab__desc">
                                    ...
                                    <table>
                                        ...
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Chuẩn</td>
                                            <td>DDR4</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        ...
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Bus</td>
                                            <td>3600Mhz</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Tản nhiệt</td>
                                            <td>Có</td>
