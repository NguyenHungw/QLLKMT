            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <h3>Màn hình LCD 24” Gigabyte G24F-EK FHD IPS 165Hz 1ms Freesync Gaming</h3>
                        ...
                        <div class="product__details__price">3,890,000₫</div>
                        <br>
                    ...
                    <div class="product__details__tab">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="product__details__tab__desc">
                                    ...
                                    <table>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            ...
                                            <td> L.24.GG.G24F-EK</td>
                                        </tr><tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Model</td>
                                            <td>G24F-EK</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Kích thước</td>
                                            <td>23.8 inch, 16:9</td>
                                        </tr>
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Tấm nền</td>
                                            <td>IPS</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Loại màn hình</td>
                                            <td>phẳng</td>
                                        </tr>
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Độ phân giải</td>
                                            <td>Full HD (1920×1080)</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Tốc độ làm mới/td>
                                            <td>165Hz , OC 170Hz</td>
                                        </tr>
                                        <tr style=" height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Công nghệ hỗ trợ</td>
                                            <td>AMD Freesync</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Thời gian đáp ứng</td>
                                            <td>1ms (MPRT) / 2ms (GTG)</td>
                                        </tr>
                                        <tr style=" height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Nổi bật</td>
                                            <td>90% DCI-P3/120% sRGB , VESA Wall Mounting(mm) 100*100mm</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Cổng kết nối</td>
                                            <td>HDMI 1.4 x2, Display port 1.2 x1 , USB 3.0*2</td>
                                        </tr>
                                        <tr style=" height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Phụ kiện</td>
                                            <td>Cáp nguồn, Cáp DisplayPort,Cáp HDMI, cáp USB</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h6>Thông tin</h6>
                                    <p>Giới thiệu Màn hình Gigabyte 24″ G24F-EK FHD IPS 165Hz 1ms Freesync Gaming<br>
                                        Độ phân giải cao và tốc độ làm mới cực nhanh lên tới 144Hz, cho bạn chất lượng hiển thị chi tiết và trải nghiệm chơi game mượt mà.<br>
                                        
                                        Màn hình 8 bits màu tuyệt vời với màu siêu rộng 95% DCI-P3 và 125% sRGB. Đơn giản nhưng phong cách là triết lý thiết kế của G24F, đại diện cho sự đơn giản, chân đế cứng và lớp hoàn thiện mờ được chế tạo cho các tính năng và thẩm mỹ.<br>
                                        
                                        Cho phép bạn đặt các tùy chọn hiển thị bằng bàn phím và chuột, cho bạn cách dễ nhất để điều chỉnh cài đặt màn hình.<br>
                                        
                                        Bảng điều khiển tiết lộ thông tin phần cứng, thời gian thực của bạn bao gồm điện áp CPU, tốc độ xung nhịp, nhiệt độ, v.v. Phần tốt nhất là nó sẽ không bị chặn bởi bất kỳ trò chơi nào.<br>
                                        
                                        Equalizer – Bộ cân bằng đen. Tính năng này cho phép bạn có thêm chi tiết về mặt tối mà không làm lộ ra mặt sáng cùng một lúc.<br>
                                        
                                        Cập nhật tự động là tính năng giúp người dùng có thể dễ dàng tận hưởng trải nghiệm chơi game tốt nhất với các tính năng GIGABYTE tiếp tục phát triển và nâng cấp đồng thời bảo vệ thêm cho màn hình của bạn.<br>
                                        
                                        Ổn định hình ảnh – Aim Stabilizer. Tính năng này sẽ làm giảm độ mờ chuyển động, do đó bạn sẽ có hình ảnh rõ nét hơn giúp truy tìm dấu vết của viên đạn và nhắm mục tiêu dễ dàng.<br>
                                        
                                        Chân đế độc quyền được thiết kế công thái học để cung cấp nhiều điều chỉnh độ cao và độ nghiêng phù hợp với góc nhìn của người dùng nhất. </p>
                                </div>
                            </div>
