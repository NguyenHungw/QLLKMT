            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <h3>SSD Kingston 500G NV2 M.2 2280 NVMe (SNV2S/500G)</h3>
                        ...
                        <div class="product__details__price">1,090,000₫</div>
                        <br>
                                ...
                                <div class="product__details__tab__desc">
                                    ...
                                    <table>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            ...
                                            <td>SS.500.KT.NV2.M2</td>
                                        </tr><tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Hãng</td>
                                            <td>Kingston</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        ...
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Kích cỡ nhỏ</td>
                                            <td>M.2 2280</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        ...
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Dung lượng</td>
                                            <td>500GB</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Tốc độ đọc</td>
                                            <td>3500MB/giây</td>
                                        </tr>
                                    </tr><tr style="height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Tốc độ ghi</td>
                                        <td>2100MB/giây</td>
                                    </tr>
                                    <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Độ bền</td>
                                        <td>160 TB</td>
                                    </tr>
                                    <tr style="height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Nhiệt độ bảo quản</td>
                                        <td>-40°C~85°C</td>
                                    </tr>
                                    <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Nhiệt độ hoạt động</td>
                                        <td>0°C~70°C</td>
                                    </tr>
                                    <tr style="height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Kích thước</td>
                                        <td>22 mm x 80 mm x 2,2 mm</td>
                                    </tr>
                                    <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                    ...
                                    <tr style="height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Độ rung khi hoạt động</td>
                                        <td>2,17 G (7-800 Hz)</td>
                                    </tr>
                                    <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        <td style="width: 250px;padding-left: 10px;" >Độ rung khi không hoạt động</td>
                                        <td>20 G (20-1.000 Hz) </td>
                                    </tr>
