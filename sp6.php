            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <h3>VGA Asus Gaming TUF OC 1660 Super 6G 2 Fan</h3>
                        ...
                        <div class="product__details__price">4,690,000₫</div>
                        <br>
                                ...
                                <div class="product__details__tab__desc">
                                    ...
                                    <table>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            ...
                                            <td> V.1660SP.6G.AS.TUF.OC.36T</td>
                                        </tr><tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Dung lượng bộ nhớ</td>
                                            <td>6GB GDDR6</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Chế độ Chơi Game - Xung Tăng cường GPU </td>
                                            <td>1815 MHZ , Xung Nền GPU : 1530 MHz</td>
                                        </tr>
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Chế độ</td>
                                            <td>OC - 1845 MHz (Xung tăng cường)</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Băng thông</td>
                                            <td>192-bit</td>
                                        </tr>
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Kết nối</td>
                                            <td>1 x DVI-D, 1 x HDMI 2.0b, 1 x DisplayPort 1.4</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Nguồn yêu cầu</td>
                                            <td>450W</td>
