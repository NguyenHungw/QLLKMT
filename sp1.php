            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <h3>Laptop Lenovo 300e Chromebook Thế hệ thứ 2 (11,6 inch)</h3>
                        ...
                        <div class="product__details__price">2,490,000₫</div>
                        <br>
                    ...
                    <div class="product__details__tab">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="product__details__tab__desc">
                                    ...
                                    <table>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Bộ xử lý</td>
                                            <td>Intel Celeron N4020 (2 core, 2 thread, 1,1 GHz up to 2.8GHz, 4MB cache)</td>
                                        ...
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            ...
                                            <td>11,6 "HD (1366 x 768) IPS touchscreen</td>
                                        </tr>
                                        <tr style="height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Giao diện</td>
                                            <td>4GB LPDDR4</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                        ...
                                        <tr style=" height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Camera</td>
                                            <td>HD 720p</td>
                                        </tr>
                                        <tr style="background-color:rgb(235, 246, 255) ; height: auto; width: 500px;">
                                            <td style="width: 250px;padding-left: 10px;" >Kích thước</td>
                                            <td>11,41 "x 8,03" x .8 "/ 290 x 204 x 20,85 (mm)</td>
                                        </tr>
                                        <tr style=" height: auto; width: 500px;">
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h6>Thông tin</h6>
                                    <p>Sẵn sàng cho bất cứ điều gì cuộc sống ném vào nó
                                        Những giáo viên nói rằng lớp học đôi khi giống như một sân chơi, hãy lấy lòng — thiết bị này được thiết kế để bền bỉ. Được chế tạo chắc chắn với các miếng đệm cao su, các cổng và bản lề được gia cố, cùng các phím được neo cơ học, Chromebook 300e (Thế hệ thứ 2) có thể xử lý mọi trường hợp va chạm và sợ hãi. Nó thậm chí còn có khả năng chống rơi lên đến 29,5 inch (75cm), gần bằng chiều cao của một chiếc bàn học.
                                         
                                        Thật hiệu quả, nó gần như làm xong bài tập về nhà của bạn
                                        Với bộ xử lý Intel N4020, Chromebook 300e (Thế hệ thứ hai) chạy liền mạch các ứng dụng từ Google Play * và Cửa hàng Chrome trực tuyến. Các ứng dụng giáo dục, đặc biệt là các ứng dụng tương tác, được thiết kế để tạo điều kiện và nâng cao khả năng học tập. Thưởng thức các mục yêu thích như Tinkercad ™ , GeoGebra, LucidChart, Jamboard, WeVideo, Kahoot !, và hơn thế nữa.
                                        </p>
                                </div>
                            </div>
